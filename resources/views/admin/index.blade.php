                            ...
                            <table class="table">
                                ...
                                @foreach($admins as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/' . $item->id) }}" title="View Admin"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/' . $item->id . '/edit') }}" title="Edit Admin"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
