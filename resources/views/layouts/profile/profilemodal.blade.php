      ...
      <div class="modal-content bg-lightblue text-dark">
          ...
          <div class="modal-body">
              <center> 
                  ...
                  @else
                      <img src="{{ asset('dash/img/undraw_profile.svg') }}" alt="Default Profile Picture" style="width: 80px;" class="img-profile rounded-circle">
                  @endif 
              ...
              <p style="padding-left: 17vh;">
                  ...
                  <a href="{{ route('admin.edit', Auth::user()->id) }}" class="btn btn-outline-dark">
